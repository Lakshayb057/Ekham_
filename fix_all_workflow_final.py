...
# 2. Card 1 Wrap
c1_old = """          <div className="bg-[#FAF8F5] border border-[#E5DCD0] rounded-[24px] p-4 sm:p-5 flex flex-col justify-between shadow-xs relative overflow-hidden h-full">"""
c1_new = """          <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: false, amount: 0.1 }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }} className="bg-[#FAF8F5] border border-[#E5DCD0] rounded-[24px] p-4 sm:p-5 flex flex-col justify-between shadow-xs relative overflow-hidden h-full">"""
c1_old_close = """              </div>
...
# 3. Card 2 Wrap
c2_old = """          <div className="bg-[#102126] border border-[#1E3037] rounded-[24px] p-4 sm:p-5 flex flex-col justify-between shadow-md relative overflow-hidden h-full group">"""
c2_new = """          <motion.div initial={{ opacity: 0, y: -50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false, amount: 0.1 }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1], delay: 0.1 }} className="bg-[#102126] border border-[#1E3037] rounded-[24px] p-4 sm:p-5 flex flex-col justify-between shadow-md relative overflow-hidden h-full group">"""
c2_old_close = """              </div>
...
# 4. Card 3 Wrap
c3_new = """          <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: false, amount: 0.1 }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1], delay: 0.2 }} className="bg-[#FAF8F5] border border-[#E5DCD0] rounded-[24px] p-4 sm:p-5 flex flex-col justify-between shadow-xs relative overflow-hidden h-full">"""
last_idx = content.rfind(c1_old)
if last_idx != -1:
    content = content[:last_idx] + c3_new + content[last_idx + len(c1_old):]
