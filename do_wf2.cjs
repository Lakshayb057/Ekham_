...
`;
  ...
  const startStr = '<div className="overflow-x-auto pb-1 scrollbar-none">';
  const endStr = '</div>\n          </div>\n\n        </div>\n\n      </div>\n    </section>\n  );\n};\n';
  
  const sIdx = w.indexOf(startStr);
  if (sIdx > -1) {
    w = w.substring(0, sIdx) + '<RoadmapLoop timelineSteps={timelineSteps} />\n        </div>\n\n      </div>\n    </section>\n  );\n};\n';
    console.log('REPLACED ROADMAP');
  } else {
  ...
  w = w.replace(/<\/div>\n\n            \{\/\* \-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\- STAGE 02/g, '</motion.div>\n\n            {/* ---------------- STAGE 02');
  w = w.replace(/<\/div>\n\n            \{\/\* \-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\- STAGE 03/g, '</motion.div>\n\n            {/* ---------------- STAGE 03');
  w = w.replace(/<\/div>\n          <\/div>\n\n          \{\/\* =========================================================================\n            BOTTOM 9-STEP ROADMAP/g, '</motion.div>\n          </motion.div>\n\n          {/* =========================================================================\n            BOTTOM 9-STEP ROADMAP');
