...
`;
  ...
  w = w.replace(
    /<div className="grid lg:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto mb-16 lg:mb-24 relative z-10">/g,
    `<motion.div 
          initial="hidden"
          whileInView="visible"
          viewport={{ once: false }}
          variants={{ visible: { transition: { staggerChildren: 0.2 } } }}
          className="grid lg:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto mb-16 lg:mb-24 relative z-10">`);
